...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    private var backgroundParticleTexture: SKTexture?
    private let backgroundSegmentHeightMultiplier: CGFloat = 2.5
    private let backgroundSegmentOverlap: CGFloat = 300
    private let backgroundSpawnAheadThresholdMultiplier: CGFloat = 1.0
